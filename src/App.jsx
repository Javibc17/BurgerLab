...
function App() {
  ...
  // Al cargar, obtener el último ticket del backend
  React.useEffect(() => {
    api.get('/tickets')
      .then(res => {
        if (res.data && res.data.length > 0) {
          setUltimoTicket(res.data[0]); // El más reciente
        }
      })
      .catch(() => {});
  }, []);
  ...
  return (
    <div className="App">
      ...
      <main className="menu-section" id="inicio">
        ...
        <MenuCategory title="ENTRANTES" items={menu.entrantes} id="entrantes" onProductClick={setSelectedProduct} />
        <MenuCategory title="HAMBURGUESAS" items={menu.hamburguesas} id="burgers" onProductClick={setSelectedProduct} />
        <MenuCategory title="POSTRES" items={menu.postres} id="postres" onProductClick={setSelectedProduct} />
            ...
            <div className="ticket-realista">
              <div className="ticket-header">
                ...
                <div className="ticket-info">
                  ...
                  <span>Fecha: {ultimoTicket.fecha}</span><br/>
                  <span>Hora: {ultimoTicket.hora}</span>
                </div>
              </div>
                      ...
                      <div key={ticket.id || idx} className="ticket-realista" style={{ marginBottom: 18 }}>
                        <div className="ticket-header">
                          ...
                          <div className="ticket-info">
                            ...
                            <span>Fecha: {ticket.fecha}</span><br/>
